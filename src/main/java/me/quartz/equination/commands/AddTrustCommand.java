...
public class AddTrustCommand implements CommandExecutor {
    @Override
            ...
            if (entity instanceof Horse) {
                if (strings.length > 0) {
                    ...
                    if (cHorse != null && cHorse.getOwners().contains(player.getUniqueId())) {
                        ...
                        cHorse.addTrust(target.getUniqueId());
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&',
                                Objects.requireNonNull(EquiNation.getInstance().getConfig().getString("messages.added-trust"))
                ...
                } else player.sendMessage(ChatColor.RED + "Usage: /htrust <player>");
