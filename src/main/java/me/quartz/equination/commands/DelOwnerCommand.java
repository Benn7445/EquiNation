...
public class DelOwnerCommand implements CommandExecutor {
    @Override
            ...
            if (entity instanceof Horse) {
                if (strings.length > 0) {
                    ...
                    if (cHorse != null && cHorse.getOwners().contains(player.getUniqueId())) {
                        ...
                        cHorse.removeOwner(target.getUniqueId());
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&',
                                Objects.requireNonNull(EquiNation.getInstance().getConfig().getString("messages.removed-owner"))
                ...
                } else player.sendMessage(ChatColor.RED + "Usage: /delowner <player>");
