...
public class DelTrustCommand implements CommandExecutor {
    @Override
            ...
            if (entity instanceof Horse) {
                if (strings.length > 0) {
                    ...
                    if (cHorse != null && cHorse.getOwners().contains(player.getUniqueId())) {
                        ...
                        cHorse.removeTrust(target.getUniqueId());
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&',
                                Objects.requireNonNull(EquiNation.getInstance().getConfig().getString("messages.removed-trust"))
                ...
                } else player.sendMessage(ChatColor.RED + "Usage: /deltrust <player>");
